Public Class VentanaConfimracionGenerica

    Private Sub VentanaConfimracionGenerica_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.CenterToParent()
        If idiomaSeleccionado.Equals("ING") Then
            btnAceptar.Text = "Acept"
            btnCancelar.Text = "Cancel"
        End If
        tbDatosSeleccionados.Focus()
        tbDatosSeleccionados.Select(tbDatosSeleccionados.Text.Length, 0)
    End Sub
